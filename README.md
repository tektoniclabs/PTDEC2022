# Perfectraveller website built with [Gatsby](https://www.gatsbyjs.org/) & [Sanity.io](https://www.sanity.io) by TronLabs
...
**Perfectraveller built with Gatsby**
...
![Architecture](/Perfectraveller_Architecture.jpg)
...
We are deploying 'master' and 'dev' branches automatically, any feature/hotfix branch can also be deployed manually on vercel. The deploy on 'master' and 'dev' is triggered by these two conditions:

- Any commit on branch
- Any content change on CMS of Sanity.io

Apart from master every single branch will point to the dev CMS while the master will point to the live CMS.

> **Deploy on Vercel:** A good starting place is to read docs available on vercel on deployment.
